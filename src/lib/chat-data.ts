...
export const generateMessages = (contactId: string): Message[] => {
  const msgs: Record<string, Message[]> = {
    "1": [
      ...
      { id: "m2", senderId: "me", text: "Hey Anna! Doing great, thanks! 😊", time: "09:12 AM", isOwn: true },
      { id: "m3", senderId: "1", text: "I've been working on the new design. Want to take a look?", time: "09:14 AM", isOwn: false },
      { id: "m4", senderId: "me", text: "Sure, send it over!", time: "09:15 AM", isOwn: true },
    ...
    "2": [
      ...
      { id: "m2", senderId: "me", text: "Of course! What do you need help with?", time: "09:21 AM", isOwn: true },
      { id: "m3", senderId: "2", text: "I've been stuck on this bug for hours 😩", time: "09:22 AM", isOwn: false },
    ],
    "3": [
      { id: "m1", senderId: "3", text: "Here's your image!", time: "09:28 AM", isOwn: false, image: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=400&h=300&fit=crop" },
      { id: "m2", senderId: "me", text: "Wow, that looks amazing! 🎨", time: "09:30 AM", isOwn: true },
    ],
  };
